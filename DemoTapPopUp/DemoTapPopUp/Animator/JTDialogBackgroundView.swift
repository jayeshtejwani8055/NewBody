...
public enum JTDialogBackgroundViewType {
    case solid
    case gradient
    case none
}

open class JTDialogBackgroundView: UIView {
    var backgroundViewType: JTDialogBackgroundViewType?
